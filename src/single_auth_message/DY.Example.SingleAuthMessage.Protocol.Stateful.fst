...
type single_message_event =
  | SenderSendMsg: sender:principal -> msg:single_message -> single_message_event
...
let receive_message comm_keys_ids receiver msg_id =
  let*? msg:communication_message single_message = receive_authenticated comm_keys_ids receiver msg_id in
